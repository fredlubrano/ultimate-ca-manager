"""PDF generation for UCM executive reports.

Contains the custom FPDF subclass with UCM branding and all section-builder
functions that produce the final PDF bytes.
"""
import io
import os
import logging
