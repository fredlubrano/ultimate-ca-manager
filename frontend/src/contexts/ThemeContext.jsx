...
const themes = {
  ...
  light: {
    ...
    isLight: true,
    colors: {
      // Softer, warmer light colors - less harsh white
      'bg-primary': '#F5F6F8',
      'bg-secondary': '#FAFBFC',
      'bg-tertiary': '#EBEEF2',
      'text-primary': '#2D3748',
      ...
      'accent-primary': '#4A7FD4',
      'accent-success': '#38A876',
      'accent-warning': '#D4930A',
      'accent-danger': '#D45454',
      'accent-pro': '#7C5AC7',
      'border': '#D8DDE5',
      'gradient-from': '#4A7FD4',
      'gradient-to': '#7C5AC7',
      'gradient-accent': 'linear-gradient(135deg, #4A7FD4 0%, #7C5AC7 100%)',
      'gradient-bg': 'linear-gradient(145deg, #f0f2f8 0%, #f5f0fa 50%, #f0f2f8 100%)',
      // DetailCard colors - softer light
      'detail-header-bg': 'linear-gradient(135deg, rgba(74,127,212,0.06), rgba(124,90,199,0.03), rgba(250,251,252,0.8))',
      'detail-header-border': 'rgba(0,0,0,0.05)',
      'detail-header-shadow': 'inset 0 1px 0 0 rgba(255,255,255,0.6)',
      'detail-icon-bg': 'linear-gradient(135deg, #4A7FD4, #6B8DD9)',
      'detail-icon-shadow': '0 4px 12px rgba(74,127,212,0.18)',
      'detail-stats-border': 'rgba(0,0,0,0.05)',
      'detail-section-bg': 'rgba(235,238,242,0.5)',
      'detail-section-border': '#D8DDE5',
      'detail-field-bg': 'rgba(0,0,0,0.015)',
      'detail-field-border': 'rgba(0,0,0,0.05)',
    }
  },
  ocean: {
    id: 'ocean',
