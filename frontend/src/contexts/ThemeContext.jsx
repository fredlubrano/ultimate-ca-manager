...
const themes = {
  ...
  light: {
    ...
    isLight: true,
    colors: {
      // Very soft, neutral light colors - no pink
      'bg-primary': '#F0F2F5',
      'bg-secondary': '#F7F8FA',
      'bg-tertiary': '#E8EAEF',
      'text-primary': '#374151',
      ...
      'accent-primary': '#5B8AD4',
      'accent-success': '#4AAA7A',
      'accent-warning': '#C4880A',
      'accent-danger': '#C75555',
      'accent-pro': '#7B6BAF',
      'border': '#D4D8E0',
      'gradient-from': '#5B8AD4',
      'gradient-to': '#7B9DD9',
      'gradient-accent': 'linear-gradient(135deg, #5B8AD4 0%, #7B9DD9 100%)',
      'gradient-bg': 'linear-gradient(145deg, #eef1f5 0%, #f0f2f5 50%, #eef1f5 100%)',
      // DetailCard colors - neutral soft
      'detail-header-bg': 'linear-gradient(135deg, rgba(91,138,212,0.05), rgba(123,157,217,0.03), rgba(247,248,250,0.9))',
      'detail-header-border': 'rgba(0,0,0,0.04)',
      'detail-header-shadow': 'inset 0 1px 0 0 rgba(255,255,255,0.5)',
      'detail-icon-bg': 'linear-gradient(135deg, #5B8AD4, #7B9DD9)',
      'detail-icon-shadow': '0 4px 12px rgba(91,138,212,0.15)',
      'detail-stats-border': 'rgba(0,0,0,0.04)',
      'detail-section-bg': 'rgba(232,234,239,0.4)',
      'detail-section-border': '#D4D8E0',
      'detail-field-bg': 'rgba(0,0,0,0.012)',
      'detail-field-border': 'rgba(0,0,0,0.04)',
    }
  },
  ocean: {
    id: 'ocean',
