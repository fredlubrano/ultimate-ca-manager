...
// Compact chain repair bar — sits under stats in ACME page
function ChainRepairBar({ data, running, onRun, t }) {
  ...
  const total = (crStats.total_cas || 0) + (crStats.total_certs || 0)
  const orphans = (crStats.orphan_cas || 0) + (crStats.orphan_certs || 0)
