        ...
        <div className="space-y-6">
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-text-primary">{new Date(selectedCA.valid_from).toLocaleDateString()}</p>
            </div>
            <div>
              <p className="text-xs text-text-secondary uppercase mb-1">Valid Until</p>
              <p className="text-sm text-text-primary">{new Date(selectedCA.valid_to).toLocaleDateString()}</p>
            </div>
            <div>
